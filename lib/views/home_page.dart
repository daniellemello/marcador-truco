...
class _HomePageState extends State<HomePage> {
              ...
              _showDialog(
                  ...
                  confirm: () {
                    _showDialog(
                      ...
                      message: 'Tem certeza que deseja zerar suas vitórias também?',
                      confirm: () {
                        _resetPlayers();
                      },
                      cancel: () {
      ...
      child: Column(
        ...
        children: <Widget>[
          _showPlayerName(name: player.name, onTap: (){
            _updatePlayerName(name: player.name, confirm: (){
              setState(() {
  ...
  // CONSTRUTOR - ALTERAR NOME 'NÓS' X ELES.
  // Pessoa pessoa = new Pessoa

  // CRIANDO UMA FUNÇÃO PARA SETAR OS NOMES DOS JOGADORES
   void _updatePlayerName({String name, Function confirm, Function cancel}) async {
    return showDialog(
